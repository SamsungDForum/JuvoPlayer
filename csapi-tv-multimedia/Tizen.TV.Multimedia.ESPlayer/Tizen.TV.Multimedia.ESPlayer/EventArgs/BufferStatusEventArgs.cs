...
{
    /// <summary>
    /// Provides event arguments for <seealso cref="ESPlayer.BufferStatusChanged"/>.
    /// </summary>
    /// <code>
    /// public void Apps()
    /// {
    ...
    /// }
    /// 
    /// public void OnBufferStatusChanged(object sender, BufferStatusEventArgs e)
    /// {
    ///     // your logic
    /// }
    /// </code>
    ...
    public class BufferStatusEventArgs : EventArgs
    {
        ...
        /// <summary>
        /// The buffer status of ESPlayer as <seealso cref="BufferStatus.Underrun"/> and <seealso cref="BufferStatus.Overrun"/> status.
        /// </summary>
