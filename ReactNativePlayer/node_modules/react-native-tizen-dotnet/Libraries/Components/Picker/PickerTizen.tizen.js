 ...
 */
class PickerTizen extends React.Component {
  props: {
    style?: $FlowFixMe,
    enabled?: boolean,
    title?: string,
  ...
  render() {
    var nativeProps = {
      ...
      style: [styles.pickerTizen, this.props.style],
...
var Picker = requireNativeComponent('RCTPicker', null);

module.exports = PickerTizen;
