 ...
 * set of items.
 */
console.log("Tizen  RCTScrollView in..........");
const ScrollView = React.createClass({
       ...
       * @platform tizen
       */
      HorizontalPageScrollLimit:PropTypes.number,
      /**
       * Controls whether iOS should automatically adjust the content inset
       * for scroll views that are placed behind a navigation bar or
       * tab bar/ toolbar. The default value is true.
       ...
       *
       */
      VerticalPageScrollLimit:PropTypes.number,
      /**
       * Controls whether iOS should automatically adjust the content inset
       * for scroll views that are placed behind a navigation bar or
       * tab bar/ toolbar. The default value is true.
...
let ScrollViewClass = RCTScrollView;
...
let RCTScrollView = requireNativeComponent('RCTScrollView', ScrollView);
