...
var ProgressBarAndroid = React.createClass({
  propTypes: {
    ...
    horizontal: ReactPropTypes.bool,
    /**
    ...
    isPulseMode: ReactPropTypes.bool,
    playPulse: ReactPropTypes.bool,
    stopPulse: ReactPropTypes.bool,
  ...
  render: function() {
    return <TizenProgressBar {...this.props} />;
  },
});

var TizenProgressBar = requireNativeComponent(
  'RCTProgressBar',
  ProgressBarAndroid,
