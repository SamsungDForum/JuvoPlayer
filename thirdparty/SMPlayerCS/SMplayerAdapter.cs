...
namespace CSPlayer
{
    public class SMplayerAdapter : IPlayerAdapter
    {
        ...
        {
            isInit = false;
            bool result = NativeSMPlayer.Initialize();
            if (result)
            {
                isInit = true;
            }
        ...
        {
            bool result = false;
            result = NativeSMPlayer.SetCurrentPositionCallback(this.OnCurrentPos, (IntPtr)0);
            if (result == false)
            {
                return result;
            }

            result = NativeSMPlayer.SetMessageCallback(this.OnMessage, (IntPtr)0);
            if (result == false)
            {
                return result;
            }

            result = NativeSMPlayer.SetAppSrcAudioSeekCallback(this.AudioSeekCB, (IntPtr)0);
            if (result == false)
            {
                return result;
            }

            result = NativeSMPlayer.SetAppSrcAudioSeekCallback(this.VideoSeekCB, (IntPtr)0);
            if (result == false)
            {
                return result;
            }

            result = NativeSMPlayer.SetAppSrcAudioNeedDataCallback(this.AudioNeedDataCB, (IntPtr)0);
            if (result == false)
            {
                return result;
            }

            result = NativeSMPlayer.SetAppSrcVideoNeedDataCallback(this.VideoNeedDataCB, (IntPtr)0);
            if (result == false)
            {
                return result;
            }

            result = NativeSMPlayer.SetAppSrcAudioDataEnoughCallback(this.AudioDataEnoughCB, (IntPtr)0);
            if (result == false)
            {
                return result;
            }

            result = NativeSMPlayer.SetAppSrcVideoDataEnoughCallback(this.VideoDataEnoughCB, (IntPtr)0);
            if (result == false)
            {
                return result;
            }
